            ...
            for (int i = 0; i < Size; i++)
            {
                ...
                switch (shapreCreator)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        _shapesClass.Add(new Rectangle_(firstRandomNumber, secondRandomNumber));
                        ...
                        break;
                    case 2:
                        _shapesClass.Add(new Triangle_(firstRandomNumber, secondRandomNumber));
                        ...
                        break;
                    default:
                        _shapesClass.Add(new Circle_(firstRandomNumber));
